...
htmlhelp_basename = 'stx-hareleasenotesdoc'
...
latex_documents = [
    ('index', 'stx-hareleasenotes.tex', u'stx-ha Release Notes',
     u'StarlingX', 'manual'),
]
...
man_pages = [
    ('index', 'stx-hareleasenotes', u'stx-ha Release Notes',
     [u'StarlingX'], 1)
]
...
texinfo_documents = [
    ('index', 'stx-haReleaseNotes', u'stx-ha Release Notes',
     u'StarlingX', 'stx-hareleasenotes',
