...
INSERT INTO "SERVICE_ACTIONS" VALUES('nova-scheduler','enable','ocf-script','openstack','nova-scheduler','start','',2,2,2,20,'');
INSERT INTO "SERVICE_ACTIONS" VALUES('nova-scheduler','disable','ocf-script','openstack','nova-scheduler','stop','',1,1,1,20,'');
INSERT INTO "SERVICE_ACTIONS" VALUES('nova-scheduler','audit-enabled','ocf-script','openstack','nova-scheduler','monitor','',2,2,2,30,20);
...
INSERT INTO "SERVICE_ACTIONS" VALUES('nova-console-auth','enable','ocf-script','openstack','nova-consoleauth','start','',2,2,2,20,'');
INSERT INTO "SERVICE_ACTIONS" VALUES('nova-console-auth','disable','ocf-script','openstack','nova-consoleauth','stop','',1,1,1,20,'');
INSERT INTO "SERVICE_ACTIONS" VALUES('nova-console-auth','audit-enabled','ocf-script','openstack','nova-consoleauth','monitor','',2,2,2,30,20);
...
INSERT INTO "SERVICE_ACTIONS" VALUES('cinder-scheduler','enable','ocf-script','openstack','cinder-schedule','start','',2,2,2,20,'');
INSERT INTO "SERVICE_ACTIONS" VALUES('cinder-scheduler','disable','ocf-script','openstack','cinder-schedule','stop','',1,1,1,20,'');
INSERT INTO "SERVICE_ACTIONS" VALUES('cinder-scheduler','audit-enabled','ocf-script','openstack','cinder-schedule','monitor','',2,2,2,30,20);
...
-- dcorch-engine
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcorch-engine','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-engine','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-engine.pid' FROM "SERVICES";
...
-- dcmanager-manager
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcmanager-manager','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcmanager-manager','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcmanager-manager.pid' FROM "SERVICES";
...
-- dcmanager-api
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcmanager-api','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcmanager-api','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcmanager-api.pid' FROM "SERVICES";
...
-- dcorch-snmp
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcorch-snmp','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-snmp','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-snmp.pid' FROM "SERVICES";
...
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcorch-sysinv-api-proxy','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-sysinv-api-proxy','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-sysinv-api-proxy.pid' FROM "SERVICES";
...
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-nova-api-proxy','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-nova-api-proxy.pid' FROM "SERVICES";
...
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcorch-neutron-api-proxy','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-neutron-api-proxy','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-neutron-api-proxy.pid' FROM "SERVICES";
...
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcorch-cinder-api-proxy','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-cinder-api-proxy','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-cinder-api-proxy.pid' FROM "SERVICES";
...
-- patch filesystem related sevices
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','controller-services','drbd-patch-vault','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','controller-services','patch-vault-fs','critical' FROM "SERVICE_GROUP_MEMBERS";

INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','drbd-patch-vault','initial','initial','none','none',2,1,90000,4,16,'' FROM "SERVICES";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','patch-vault-fs','initial','initial','none','none',2,1,90000,4,16,'' FROM "SERVICES";
...
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'no','distributed-cloud-services','dcorch-patch-api-proxy','critical' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'no','dcorch-patch-api-proxy','initial','initial','none','none',2,1,90000,4,16,'/var/run/resource-agents/dcorch-patch-api-proxy.pid' FROM "SERVICES";
...
INSERT INTO CONFIGURATION("KEY", "VALUE") VALUES("ENABLING_THROTTLE", "2");
update "SERVICE_ACTIONS" set TIMEOUT_IN_SECS=60 where action in ('enable', 'audit-enabled') and service_name in ('nova-scheduler', 'nova-console-auth', 'cinder-scheduler');
