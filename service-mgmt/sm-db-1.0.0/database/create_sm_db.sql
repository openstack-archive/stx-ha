...
INSERT INTO "SERVICE_GROUP_MEMBERS" SELECT MAX(id) + 1,'yes','cloud-services','dbmon','minor' FROM "SERVICE_GROUP_MEMBERS";
INSERT INTO "SERVICES" SELECT MAX(id) + 1,'yes','dbmon','initial','initial','none','none',2,1,90000,4,16,'' FROM "SERVICES";
