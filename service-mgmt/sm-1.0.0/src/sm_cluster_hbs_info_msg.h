...
//       handle routine requesting and processing cluster hbs info from
//       hbsAgent a query is sent to hbsAgent every configurable interval
//       to keep track of most up-to-date info prior to a failure occurs
//       also provides on-demand async query with callback when respond
// ========================
class SmClusterHbsInfoMsg
{
    public:
    ...
    private:
        ...
        static bool cluster_hbs_info_query(SmTimerIdT timer_id, int64_t user_data);
