...
// ====================================
SmErrorT sm_service_group_disabled_state_entry(
    SmServiceGroupT* service_group )
{
    SmErrorT error;

    error = sm_service_group_notification_notify(
                    service_group, SM_SERVICE_GROUP_NOTIFICATION_DISABLED );
    if( SM_OKAY != error )
    {
...
// ===================================
SmErrorT sm_service_group_disabled_state_exit( 
    SmServiceGroupT* service_group )
{
    SmErrorT error;
...
// =========================================
SmErrorT sm_service_group_disabled_state_transition(
...
// =========================================
SmErrorT sm_service_group_disabled_state_initialize( void )
{
    return( SM_OKAY );
}
// ****************************************************************************
...
// =======================================
SmErrorT sm_service_group_disabled_state_finalize( void )
{
    return( SM_OKAY );
}
// ****************************************************************************
